			...
			<main class="main">
				<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
					<div class="col-md-8 mx-auto my-5 banner-text">
						<h2 class="display-3 font-weight-weight my-4">If we can connect, we can create a better future.</h2>
						<a class="btn btn-info btn-lg" href="#">Contact us</a>
					</div>
					<div class="box-shadow d-none d-md-block">
						<img src="https://images.prismic.io/korus-connect%2Fe206adad-744c-4362-bd28-f88ebf38beda_asset+14.svg?auto=format%2Ccompress&amp;fit=max&amp;q=50" ></div>
				</div>
