...
<main class="content-wrapper">	
	...
	<div class="form-content">
		<div class="form-item">
			<h3 class="form-heading" ><spring:message code="label.heading"></spring:message></h3>
			<p class="form-subheading"> <spring:message code="label.requirements"></spring:message></p>
		</div>
		...
		<form:form modelAttribute="tariff" action="" method="post" >
			...
			<div class="form-item">
				<form:label path="subscriptionFee">
					...
					<form:input class="form-control" type="text" path="subscriptionFee" name="subscriptionFee"/>
				</form:label>
			...
			<div class="form-item">
				<form:label path="numberOfMegabytes">
					...
					<form:input class="form-control" type="text" path="numberOfMegabytes" name="numberOfMegabytes"/>
				</form:label>
			...
			<div class="form-item">
				<form:label path="description">
					...
					<form:input class="form-control" type="text" path="description" name="description" />
				</form:label>
